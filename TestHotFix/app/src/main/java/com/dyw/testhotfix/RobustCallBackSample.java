...
public class RobustCallBackSample implements RobustCallBack {
    ...
    public RobustCallBackSample(Context context, TextView textView) {
    ...
    public void onPatchListFetched(boolean result, boolean isNet, List<Patch> patches) {
        ...
        setProcess("onPatchListFetched result: " + result + "，isNet: " + isNet);
    ...
    public void onPatchFetched(boolean result, boolean isNet, Patch patch) {
        ...
        setProcess("onPatchFetched result: " + result + "，isNet: " + isNet + "，patch: " + patch.getName());
    ...
    public void onPatchApplied(boolean result, Patch patch) {
        ...
        setProcess("onPatchApplied result: " + result + "，patch: " + patch.getName());
    }
    ...
    public void logNotify(String log, String where) {
        ...
        setProcess("logNotify log: " + log + "，where: " + where);
    }
    ...
    public void exceptionNotify(Throwable throwable, String where) {
        ...
        setProcess("exceptionNotify where: " + where + "，throwable: " + throwable.getMessage());
    }
